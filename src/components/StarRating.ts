// ABOUTME: Interactive star-rating widget rendering a 1–10 scale as 10 stars with 0.5-step half fills.
// ABOUTME: Pass readonly=true to display without interaction; onChange fires the chosen 1–10 value.
